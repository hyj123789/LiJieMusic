...
data class Rv1Data (
    val code: Int,
    val playlists: List<PlaylistInfo1>
)

data class PlaylistInfo1(
    val id: Long,          //歌单ID
    val name: String,      //歌单名字
    val coverImgUrl: String,    //封面图链接
    val description : String,   //播放量
)
...
//            "subscribedCount": 36038,
//            "trackCount": 125,
//            "cloudTrackCount": 0,
//            "coverImgUrl": "http://p3.music.126.net/SA6bW1UlPP04rFB2pj-FvQ==/109951165813403264.jpg",
